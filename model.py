...
## Same as model #7, last model - but trained on new agile trainer (continuousTrainer.py), see training-tools directory.
##
...
## We only want images that are not braking and is moving - have speed.
...
# training is over - save model and weights to disk.
