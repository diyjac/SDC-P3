...
sim_img = pygame.surface.Surface((320,160),0,24).convert()
model_img = pygame.surface.Surface((320,160),0,24).convert()
...
def telemetry(sid, data):
    ...
    sim_img = pygame.image.fromstring(image.tobytes(), (320, 160), 'RGB')
